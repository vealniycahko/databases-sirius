...
(
    equipment_id int references equipment on delete cascade,
    holder_id    int references holder on delete cascade,
    primary key (equipment_id, holder_id) -- ОБЯЗАТЕЛЬНО НУЖНО ЗАДАТЬ primary key !!!
);
